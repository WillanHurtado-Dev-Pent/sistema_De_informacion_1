      ...
      <div class="row">
        ...
        <div class="col-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->            
            <form role="form" action="{{ route('categoria.update', $categoria->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputText1" placeholder="Enter ..." name="nombre" value="{{$categoria->nombre}}" required>
                </div>
                {{-- <div class="form-group">
              ...
              <div class="card-footer">
                ...
                <a class="btn btn-secondary" href="{{ route('categoria.index')}}">Cancelar</a>
              </div>
            </form>
          </div>
          <!-- /.card -->
