      ...
      <div class="row">
        ...
        <div class="col-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" action="{{ route('paquete.update', $paquete->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputText1" placeholder="Enter ..." name="nombre" value="{{$paquete->descripcion}}" required>
                </div>
                <div class="form-group">
                  <label for="exampleInputText1">Nombre</label>
                  <input type="text" class="form-control" id="exampleInputText1" placeholder="Enter ..." name="nombre" value="{{$paquete->nombre}}" required>
                </div>
                {{-- <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="exampleInputNumber1" placeholder="Enter ..." name="telefono" value="{{$paquete->precio}}" required>
                </div>
                {{-- <div class="form-group">
              ...
              <div class="card-footer">
                ...
                <a class="btn btn-secondary" href="{{ route('paquete.index')}}">Cancelar</a>
              </div>
            </form>
          </div>
          <!-- /.card -->
