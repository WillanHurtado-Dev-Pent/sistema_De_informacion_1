      ...
      <div class="row">
        ...
        <div class="col-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" action="{{ route('servicio.update', $servicio->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputText1" placeholder="Enter ..." name="nombre" value="{{$servicio->descripcion}}" required>
                </div>
                <div class="form-group">
                  <label for="exampleInputText1">Nombre</label>
                  <input type="text" class="form-control" id="exampleInputText1" placeholder="Enter ..." name="nombre" value="{{$servicio->nombre}}" required>
                </div>
                {{-- <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="exampleInputNumber1" placeholder="Enter ..." name="telefono" value="{{$servicio->precio}}" required>
                </div>
                {{-- <div class="form-group">
              ...
              <div class="card-footer">
                ...
                <a class="btn btn-secondary" href="{{ route('proveedor.index')}}">Cancelar</a>
              </div>
            </form>
          </div>
          <!-- /.card -->
