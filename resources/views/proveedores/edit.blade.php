      ...
      <div class="row">
        ...
        <div class="col-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" action="{{ route('proveedor.update', $proveedor->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputText1" placeholder="Enter ..." name="nombre" value="{{$proveedor->nombre}}" required>
                </div>
                {{-- <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="exampleInputNumber1" placeholder="Enter ..." name="telefono" value="{{$proveedor->telefono}}" required>
                </div>
                {{-- <div class="form-group">
